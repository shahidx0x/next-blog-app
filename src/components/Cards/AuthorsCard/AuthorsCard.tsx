...
const AuthorsCard = () => {
  return (
    <div className="w-96 ">
      <div className="border border-gray-3 rounded-[20px] bg-gray p-5 group-hover:bg-white hover:drop-shadow-1 hover:-translate-y-2 transition-all">
        <div className="flex flex-wrap items-center gap-8">
          ...
          <div>
            <h3 className="font-semibold text-xl text-gray-500 mb-1">
              Ryna Kenter
            </h3>
            <p className="text-sm">Content Writer</p>
            <span className="flex items-center gap-2 text-sm mt-2.5">
              <svg
